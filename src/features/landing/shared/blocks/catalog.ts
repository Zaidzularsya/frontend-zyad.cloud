...
export const BLOCK_CATALOG: BlockDefinition[] = [
  ...
  },
  {
    ...
    sectionType: 'content',
    variant: 'element.container',
    label: 'Container',
    description: 'Pembungkus dengan lebar maks, padding, dan beberapa elemen di dalamnya.',
    icon: 'dashboard',
    group: 'layout',
    kind: 'layout',
    keyPrefix: 'container',
    defaultContent: {
      ...
      align: 'stretch',
      items: [
        { kind: 'headline', text: 'Judul di dalam container', level: 'h3' },
        {
          kind: 'paragraph',
          bodyHtml: 'Tambahkan elemen (judul, paragraf, tombol, gambar) lewat panel properti.',
        },
      ],
    },
    defaultStyle: {
    ...
    schema: [
      { key: 'maxWidth', label: 'Lebar maks (px)', type: 'number' },
      { key: 'padding', label: 'Padding (px)', type: 'number' },
      { key: 'gap', label: 'Jarak antar item (px)', type: 'number' },
      {
        key: 'align',
        label: 'Perataan',
        type: 'select',
        ...
        itemSchema: [
          {
            ...
            label: 'Jenis',
            type: 'select',
            options: ['headline', 'paragraph', 'button', 'image'],
          },
          { key: 'text', label: 'Teks judul', type: 'text' },
          { key: 'level', label: 'Level judul', type: 'select', options: ['h2', 'h3', 'h4'] },
          { key: 'bodyHtml', label: 'Isi paragraf', type: 'textarea' },
          { key: 'label', label: 'Label tombol', type: 'text' },
          { key: 'url', label: 'URL tombol', type: 'url' },
          { key: 'target', label: 'Buka di', type: 'select', options: ['_self', '_blank'] },
          { key: 'src', label: 'URL gambar', type: 'image' },
          { key: 'alt', label: 'Teks alternatif gambar', type: 'text' },
        ],
      },
    ],
  },
  {
    id: 'element.grid',
    sectionType: 'content',
    variant: 'element.grid',
    label: 'Grid',
    description: 'Kisi responsif berisi kartu atau elemen (kolom berbeda per breakpoint).',
    icon: 'grid_view',
    group: 'layout',
    kind: 'layout',
    keyPrefix: 'grid',
    defaultContent: {
      ...
      gap: 16,
      cells: [
        { kind: 'card', title: 'Kartu satu', bodyHtml: 'Deskripsi singkat kartu.' },
        { kind: 'card', title: 'Kartu dua', bodyHtml: 'Deskripsi singkat kartu.' },
        { kind: 'card', title: 'Kartu tiga', bodyHtml: 'Deskripsi singkat kartu.' },
      ],
    },
    defaultStyle: {
      variant: 'element.grid',
    ...
    schema: [
      { key: 'columns', label: 'Kolom (desktop)', type: 'number' },
      { key: 'columnsTablet', label: 'Kolom (tablet)', type: 'number' },
      { key: 'columnsMobile', label: 'Kolom (mobile)', type: 'number' },
      { key: 'gap', label: 'Jarak antar sel (px)', type: 'number' },
      {
        key: 'cells',
        label: 'Sel',
        type: 'repeater',
        itemSchema: [
          {
            ...
            label: 'Jenis',
            type: 'select',
            options: ['card', 'headline', 'paragraph', 'button', 'image'],
          },
          { key: 'title', label: 'Judul kartu', type: 'text' },
          { key: 'bodyHtml', label: 'Isi kartu / paragraf', type: 'textarea' },
          { key: 'imageSrc', label: 'Gambar kartu', type: 'image' },
          { key: 'buttonLabel', label: 'Label tombol kartu', type: 'text' },
          { key: 'buttonUrl', label: 'URL tombol kartu', type: 'url' },
          { key: 'text', label: 'Teks judul (jenis headline)', type: 'text' },
          { key: 'level', label: 'Level judul', type: 'select', options: ['h2', 'h3', 'h4'] },
          { key: 'label', label: 'Label tombol (jenis button)', type: 'text' },
          { key: 'url', label: 'URL tombol (jenis button)', type: 'url' },
          { key: 'src', label: 'URL gambar (jenis image)', type: 'image' },
          { key: 'alt', label: 'Teks alternatif gambar', type: 'text' },
        ],
      },
    ],
