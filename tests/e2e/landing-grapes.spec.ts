...
const GRAPES_HTML =
  `<div data-zyad-slot="tenant-nav" data-zyad-header='{"sticky":true,"variant":"solid","align":"left","showAction":true,"actionLabel":"Masuk","actionUrl":"/login"}'><span>placeholder nav</span></div>` +
